...
"}")
        ...
        self.machineScrollAreaWidget.setGeometry(QRect(0, 0, 703, 484))
...
"color: rgb(80, 80, 80);")
        ...
        self.verticalLayout_21 = QVBoxLayout(self.shutdown_page)
        ...
        self.shutdown_title.setFont(font8)
...
"border-radius: 15px;")
        ...
        self.verticalLayout_21.addWidget(self.shutdown_title)

        self.widget_4 = QWidget(self.shutdown_page)
...
"}")
        ...
        self.horizontalLayout_14.setContentsMargins(50, -1, 50, -1)
        self.confirm_shutdown = QPushButton(self.widget_4)
        ...
        self.confirm_shutdown.setFont(font16)
        self.confirm_shutdown.setStyleSheet(u"")
        self.confirm_shutdown.setIcon(icon3)
        self.confirm_shutdown.setIconSize(QSize(50, 50))

        self.horizontalLayout_14.addWidget(self.confirm_shutdown)

        self.cancel_shutdown = QPushButton(self.widget_4)
        self.cancel_shutdown.setObjectName(u"cancel_shutdown")
        self.cancel_shutdown.setMinimumSize(QSize(0, 52))
        self.cancel_shutdown.setFont(font16)
        self.cancel_shutdown.setStyleSheet(u"")
        icon5 = QIcon()
        icon5.addFile(u":/assets/keyboard/cancel.png", QSize(), QIcon.Normal, QIcon.Off)
        self.cancel_shutdown.setIcon(icon5)
        self.cancel_shutdown.setIconSize(QSize(50, 50))

        self.horizontalLayout_14.addWidget(self.cancel_shutdown)
...
"border-radius: 15px;")
        ...
        self.weighing_group.setFont(font17)
...
"}")
        ...
        font18.setBold(True)
        self.weighing_min_label.setFont(font18)
        ...
        self.weighing_max_label.setFont(font18)
        ...
        self.weighing_average_label.setFont(font18)
        ...
        font19 = QFont()
        font19.setPointSize(1)
        self.timeout_group.setFont(font19)
        ...
        self.timeout_title.setFont(font20)
...
"border-radius: 8px;")
        ...
        self.current_weight.setFont(font22)
        ...
        self.weighing_widget_group.setGeometry(QRect(0, 0, 773, 368))
...
"")
        ...
        self.groupBox_6.setFont(font18)
...
"}")
        ...
        self.view_pages_group_2.setFont(font18)
...
"}")
        ...
        self.tabletListContents.setGeometry(QRect(0, 0, 711, 243))
        ...
        self.view_pages_group.setFont(font18)
...
"")
        ...
        self.machine_page_view.setFont(font24)
        ...
        self.weighing_settings_page_view.setFont(font24)
        ...
        self.characteristics_page_view.setFont(font24)
        ...
        self.weighing_page_view.setFont(font24)
...
"}")
        ...
        self.verticalLayout_42.setContentsMargins(15, -1, 9, -1)
        ...
        self.restart_program_2.setFont(font25)
...
"	font-weight: bold;\n"
"}")
        self.verticalLayout_10 = QVBoxLayout(self.show_sidebar)
        self.verticalLayout_10.setSpacing(30)
        self.verticalLayout_10.setObjectName(u"verticalLayout_10")
        self.verticalLayout_10.setContentsMargins(15, 9, -1, -1)
        ...
        self.develops_1.setFont(font27)
        ...
        self.shutdown.setFont(font25)
        self.shutdown.setCursor(QCursor(Qt.PointingHandCursor))
        icon19 = QIcon()
        icon19.addFile(u":/assets/icon/shutdown1.png", QSize(), QIcon.Normal, QIcon.Off)
        self.shutdown.setIcon(icon19)
        ...
        self.restart_program_1.setFont(font25)
